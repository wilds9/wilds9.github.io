...
(defun duncan/head-common-list (plist)
  ...
  (let ((description "The Personal Home Page of Hui De-Xuan"))
    (list
...
(defvar duncan--publish-project-alist
  (list
   ...
   (list "archive"
         ...
         :html-link-home "http://dxnotes.com/"
   ...
   (list "assets"
         ...
         :include '("CNAME" ".nojekyll" "publish.el")
         :recursive t
...
(defun duncan-publish-all ()
  ...
  (let ((make-backup-files nil)
        ...
        (user-full-name "Hui De-Xuan")
        (user-mail-address "huidexuan@gmail.com")
